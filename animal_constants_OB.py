...
# Replacement cost
REPLACEMENT_COST = 1300 # per hd, average of 2024 Nov to 2025 Oct (12 months) from USDA https://mymarketnews.ams.usda.gov/viewReport/2957
# Calf price
CALF_PRICE = 100 # per hd, average of heifer calf and bull calf 2024 Nov to 2025 Oct (12 months) from USDA https://mymarketnews.ams.usda.gov/viewReport/2957
# Slaughter prices 
SLAUGHTER_PRICE = 0.84 # per kg, according to average of 2024 Nov to 2025 Oct (12 months) from USDA https://mymarketnews.ams.usda.gov/viewReport/2957 # avg of $266/cwt for dressed cow (breaker, boner, cutter) * 55% = $146.3/cwt = $146.3/45.3592 kg 3.23/kg
...
PRODUCTION_MULT_MEAN = 1.0
PRODUCTION_MULT_SD   = 0.11
PRODUCTION_MULT_MIN  = 0.67   # ~ -3 SD, truncation floor
PRODUCTION_MULT_MAX  = 1.33   # ~ +3 SD, truncation ceiling
